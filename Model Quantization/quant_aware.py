# Reference: https://leimao.github.io/blog/PyTorch-Quantization-Aware-Training/
...
def train_model(
    ...
    # It seems that SGD optimizer is better than Adam optimizer for ResNet18
    # training on CIFAR10.
    optimizer = optim.SGD(
        model.parameters(),
        lr=learning_rate,
...
def main():
    ...
    model = load_model(
        ...
        device=cuda_device)
    # Move the model to CPU since static quantization does not support CUDA
    # currently.
    model.to(cpu_device)
